...
WITH (
    FIELDTERMINATOR = ',',
    ROWTERMINATOR = '\n',
	--ROWTERMINATOR = '0x0a', --IF YOU SEE BULK INSERT ERRORS, TRY COMMENTING OUT THE PREVIOUS "ROWTERMINATOR" LINE AND RUN THE COMMAND WITH THE HEXIDECIMAL ROWTERMINATOR CHARACTER INSTEAD.
	FIRSTROW = 2
)
